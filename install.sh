...
#link izin ip vps
url_izin='https://raw.githubusercontent.com/sajauguida7678982eguhguw78t376r6736734f/refggrfhsrfxhfrhfhfdggd/main/izin.txt'
...
# Other
cd /usr/bin
wget -q -O m.zip "https://raw.githubusercontent.com/jvoscript/Autoscript/main/1.14.zip"
yes A | unzip m.zip
rm -fr m.zip
chmod +x *
cd /usr/bin/rere
...
"
CHATID="7417223697"
KEY="7354415664:AAEy4nNql_j7FHRzAB7yAvF_0_AuSi0LKNE"
TIME="10"
